...
public class Listner extends TestBase implements ITestListener{
	...
	public void onTestSuccess(ITestResult result) {
		...
		String methodName = result.getName();
        	...
        	File destFile = new File(currentUsersHomeDir+"\\src\\main\\java\\DeltaxRegistration\\Delatx_registartiongForm\\customListner\\"+methodName+"Success_"+formater.format(cal.getTime())+".png");
        	try {
        	...
        	log("screenshot has been succesfuly taken for failur method: "+methodName);
//        	log.info();
//        	Reporter.log("screenshot has been taken for "+methodName);
	...
	public void onTestFailure(ITestResult result) {
        ...
        if (!result.isSuccess()) {
        	...
        	File srcFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        	String currentUsersHomeDir = System.getProperty("user.dir");
        	File destFile = new File(currentUsersHomeDir+"\\src\\main\\java\\DeltaxRegistration\\Delatx_registartiongForm\\customListner\\"+methodName+"failuer_"+formater.format(cal.getTime())+".png");
        	try {
    			org.apache.commons.io.FileUtils.copyFile(srcFile, destFile);
    			// using Reporter log will create link of images which will used in reporting
    			Reporter.log("<a href='"+destFile.getAbsolutePath()+"'> <img src='"+destFile.getAbsolutePath()+"'height='100' width ='100'/> </a>");
...
//        	Reporter.log("screenshot has been taken for "+methodName);
	...
	public void onTestSkipped(ITestResult result) {
		...
		log(" Test skipped"+result.toString());
//		Reporter.log();
//		
	}
	...
	public void onStart(ITestContext context) {
		// TODO Auto-generated method stub
		log(" Test Started"+ context.toString());
